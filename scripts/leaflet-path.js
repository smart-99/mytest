...
(function (global, factory) {
    ...
    var MultiCanvas = L.Renderer.extend({
        ...
        _drawCruise: function (ctx, color) {
            Span4.innerHTML= delaytime/1000;
            sleep(delaytime);
            num++;


            if (color == '#FF0000') {
                Span2.innerHTML= "speed < 20"; // Red1
            } 
              else if (color == '#FF4500') {
                Span2.innerHTML= "20 - 40"; // Red1
            } 
               else if (color == '#FF3030') {
                Span2.innerHTML= "40-60"; // Red1
            } else if (color == '#FFA500') {
                Span2.innerHTML= "60-80"; // Red1
            } else if (color == '#FFD700') {
                Span2.innerHTML= "80-100"; // Red1
            } else if (color == '#FFFF00') {
                Span2.innerHTML= "100-120"; // Red1
            } else if (color == '#C0FF3E') {
                Span2.innerHTML= "120-150"; // Red1
            } else if (color == '#7FFF00') {
                Span2.innerHTML= "150-250"; // Red1
            } else if (color == '#00FF00') {
                Span2.innerHTML= "> 250"; // Red1
            }


            div.innerHTML= num;
            Span1.innerHTML= speedArray[num].toFixed(3);
            Span3.innerHTML= pathArray[num];
    ...
    var FileInput = L.Control.extend({
        ...
        _fileReader: function () {
            ...
            var filepath = "E:\MY_GPS_Test\data\2020data1.txt";   //   "E:\\MY_GPS_Test\\data\\2020data1.txt"
//            file = fso.GetFile(filepath);
//            file = "E:\MY_GPS_Test\data\2020data1.txt";                    // E:\MY_GPS_Test\data\2020data1.txt;
